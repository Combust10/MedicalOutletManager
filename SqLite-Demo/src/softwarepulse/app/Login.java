...
public class Login extends JFrame {
	...
	public Login() throws ClassNotFoundException, SQLException {
		...
		lblNewLabel.setBounds(241, 24, 80, 36);
		panel.add(lblNewLabel);
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("Arial", Font.BOLD, 30));
		
		JLabel lblNewLabel_1 = new JLabel("Username");
		lblNewLabel_1.setBounds(120, 122, 65, 14);
		panel.add(lblNewLabel_1);
		
		textField = new JTextField();
		textField.setBounds(224, 119, 145, 20);
		panel.add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_2 = new JLabel("Password");
		lblNewLabel_2.setBounds(121, 177, 64, 14);
		panel.add(lblNewLabel_2);
		
		textField_1 = new JPasswordField();
		textField_1.setBounds(224, 174, 145, 20);
		panel.add(textField_1);
		textField_1.setColumns(10);
		
		JButton btnNewButton = new JButton("Enter");
		btnNewButton.setBounds(224, 229, 113, 33);
		...
		lblNewLabel_3.setBounds(-12, -19, 616, 354);
